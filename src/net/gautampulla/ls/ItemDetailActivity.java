package net.gautampulla.ls;

import net.gautampulla.ls.Data.Item;
...
public class ItemDetailActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button saveButton = (Button)findViewById(R.id.detail_item_SaveButton);
		...
		Button deleteButton = (Button)findViewById(R.id.detail_item_DeleteButton);
		...
		Button cancelButton = (Button)findViewById(R.id.detail_item_CancelButton);
